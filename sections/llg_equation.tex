% Adapted from Eqs. (1)--(4) of Z. Kong et al., J. Appl. Phys. 140,
% 063903 (2026), doi:10.1063/5.0326907, by removing the atom index i.
\paragraph{LLGS form with field-like torque.}
\begin{align}
    \frac{\dd\mvec}{\dd t}
    ={}& -\gamma\,\mvec\times\Heff
...
\begin{align}
    ...
    ={}& -\gamma\,\mvec\times\Heff
         - \alpha\gamma\,\mvec\times\bigl(\mvec\times\Heff\bigr)
         \notag\\
...
$\beta>0$~\cite{park2014macrospin}.  Specifically, the
